...
import com.sosauce.cinnamon.core.utils.Spacer
import com.sosauce.cinnamon.core.utils.createDefaultSmsIntent

@SuppressLint("InlinedApi")
@Composable
fun SetupDefaultMessageApp(
    onNext: () -> Unit
) {
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.default_sms_app_desc),
        ...
        Button(
            onClick = {
                launcher.launch(context.createDefaultSmsIntent())
            },
