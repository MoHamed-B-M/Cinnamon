package com.sosauce.cinnamon.data.local.db.datastore
...
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.ARCHIVED_CONVOS
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.DEFAULT_MESSAGES_SIM
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.DEFAULT_TAB
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.ENABLE_DELIVERY_REPORTS
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.ENABLE_T9_DIALING
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.GROUP_SUBSEQUENT_CALLS
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.MMS_MAX_SIZE_LIMIT
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.PALETTE_STYLE
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.PINNED_CONVOS
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.SEND_GROUP_AS_MMS
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.SEND_LONG_AS_MMS
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.SHOW_CHAR_COUNT
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.SORT_CONTACTS_ASCENDING
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.SORT_CONVERSATIONS_ASCENDING
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.SORT_LOGS_ASCENDING
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.THEME
import com.sosauce.cinnamon.data.local.db.datastore.PreferencesKeys.USE_SYSTEM_FONT
